...
export default function RefundsPage() {
  return (
    <main className="wrap legal">
      ...
      <p>
        If it&apos;s our mistake, we issue the refund to your original
        payment method through Clover once we&apos;ve confirmed the issue.
      </p>
